...
const PrivacyPolicy = () => {
  return (
    <div className="bg-gray-800">
      <div className="max-w-3xl bg-gray-800 mx-auto py-8 text-white">
        ...
        <p className="mb-4">
          ...
          collected and recorded by Eco Collectors and how we use it.
        </p>
        ...
        <p className="mb-4">
          ...
          shared and/or collect in Eco Collectors. This policy is not applicable
        ...
        <p className="mb-4">
          Eco Collectors follows a standard procedure of using log files. These
        ...
        <p className="mb-4">
          Like any other website, Eco Collectors uses "cookies". These cookies
        ...
        <p className="mb-4">
          ...
          advertising partners of Eco Collectors.
        </p>

        <p className="mb-4">
          Third-party ad servers or ad networks use technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on Eco Collectors, which are sent
        ...
        <p className="mb-4">
          Note that Eco Collectors has no access to or control over these
        ...
        <p className="mb-4">
          Eco Collectors's Privacy Policy does not apply to other advertisers or
        ...
        <p className="mb-4">
          Eco Collectors does not knowingly collect any Personal Identifiable
