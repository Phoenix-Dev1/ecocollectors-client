          ...
          <div className="md:w-1/3 bg-eco-primary/5 p-10 flex flex-col justify-between border-b md:border-b-0 md:border-r border-gray-100">
            ...
            <div className="mt-10 space-y-6">
              <div className="flex items-center space-x-5 group">
                <div className="w-12 h-12 bg-eco-primary rounded-2xl shadow-lg shadow-eco-primary/20 flex items-center justify-center text-white transition-transform duration-300 group-hover:scale-110">
