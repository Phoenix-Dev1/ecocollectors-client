    ...
    <div className="min-h-screen bg-eco-background flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-4xl animate-fade-in relative z-10">
        <div className="glass !rounded-[2.5rem] shadow-2xl shadow-eco-primary/5 border border-white/40 overflow-hidden flex flex-col md:flex-row">
          ...
          <div className="md:w-[40%] bg-eco-primary/5 p-6 md:p-10 flex flex-col justify-between border-b md:border-b-0 md:border-r border-gray-100">
            <div>
            ...
            <div className="mt-10 space-y-6">
              <div className="flex items-center space-x-5 group">
                <div className="w-12 h-12 flex-shrink-0 aspect-square bg-eco-primary rounded-2xl shadow-lg shadow-eco-primary/20 flex items-center justify-center text-white transition-transform duration-300 group-hover:scale-110">
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M3 8l7.89 5.26a2 2 0 002.22 0L22 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                </div>
                <span className="text-eco-text font-bold text-[13px] md:text-sm break-words">support@ecocollectors.com</span>
              </div>
              <div className="flex items-center space-x-5 group">
                <div className="w-12 h-12 flex-shrink-0 aspect-square bg-eco-primary rounded-2xl shadow-lg shadow-eco-primary/20 flex items-center justify-center text-white transition-transform duration-300 group-hover:scale-110">
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                </div>
                <span className="text-eco-text font-bold text-[13px] md:text-sm">Haifa, Israel</span>
              </div>
            </div>
          </div>

          {/* Form Content */}
          <div className="md:w-[60%] p-10 bg-white/40">
